...
% 
% Code modified from: https://www.mathworks.com/help/images/neural-style-transfer-using-deep-learning.html

function transferImage = StyleTransfer(contentImage, styleImage)
    %% Load Data
